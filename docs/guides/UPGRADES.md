...
**File:** [`crates/common/chains/tests/hardfork_consistency.rs`](https://github.com/OPENSCI-Labs/sci-chain/blob/main/crates/common/chains/tests/hardfork_consistency.rs)
