...
The
[`SpawnedConsumer`](https://github.com/OPENSCI-Labs/sci-chain/blob/main/crates/execution/txpool/src/consumer/mod.rs)
polls the transaction pool for new pending transactions and broadcasts them through a
`tokio::broadcast` channel. The
[`SpawnedForwarder`](https://github.com/OPENSCI-Labs/sci-chain/blob/main/crates/execution/txpool/src/forwarder/mod.rs)
...
-
  [`crates/execution/txpool/src/consumer/`](https://github.com/OPENSCI-Labs/sci-chain/tree/main/crates/execution/txpool/src/consumer)
  — Transaction pool consumer
-
  [`crates/execution/txpool/src/forwarder/`](https://github.com/OPENSCI-Labs/sci-chain/tree/main/crates/execution/txpool/src/forwarder)
